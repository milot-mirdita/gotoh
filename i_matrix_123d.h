...
class i_matrix_123d : public i_matrix
{
protected:
	config_123d* config;
...
public:
	i_matrix_123d(unsigned int size, substitution_matrix* substitution, int gap_open, int gap_extend, config_123d* config) 
		: i_matrix(size, substitution, gap_open, gap_extend), config(config) {
